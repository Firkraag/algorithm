...
class TestMostReliablePath(unittest.TestCase):
    def test_most_reliable_path(self):
        ...
        self.assertEqual([i.p for i in vertices], [None, s, u, s])
        self.assertEqual([round(i.r, 2) for i in vertices], [1, 0.2, 0.14, 0.15])
        most_reliable_path(G, r, u)
        self.assertEqual([i.p for i in vertices], [None, None, u, u])
        self.assertEqual([round(i.r, 2) for i in vertices], [0, 1, 0.7, 0.6])
